...
curl -s -X POST -H "Authorization: Bearer $WEBEX_TEAMS_ACCESS_TOKEN" -H "Content-Type: application/json" --data '{"roomId":"Y2lzY29zcGFyazovL3VzL1JPT00vODE5NDliZjAtOThjOS0xMWVhLTg0YWQtNTU5ZmM5OThhNTE2","text":"'"$(<status.txt)"'"}' https://webexapis.com/v1/messages
